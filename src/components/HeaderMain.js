    ...
    <div className="flex items-center justify-center p-4 bg-white shadow-md">
      ...
      <div className="flex items-center gap-5 ml-auto mr-5">
        <span className="relative w-8">
          ...
          <span className="absolute top-0 right-0 flex items-center justify-center w-5 h-5 text-xs text-white translate-x-1/2 bg-pink-600 rounded-full">
            {cartItemsCount || 0}
          </span>
        </span>
        <span className="relative w-8">
      ...
      <button
        className="p-2 ml-auto text-black bg-gray-200 rounded-md"
